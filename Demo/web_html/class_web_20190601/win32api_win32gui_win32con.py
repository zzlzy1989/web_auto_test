# #!/usr/bin/env python
# # -*- coding: utf-8 -*-
# # @Time     : 2019/6/19 0019 23:21
# # @Author   : 蓝天下的风
# # @File     : win32api_win32gui_win32con.py
...
#
# # 关闭窗口
# win32gui.PostMessage(pip install pypiwin32.findWindow(classname, titlename), win32con.WM_CLOSE, 0, 0)
#
#
# # 检查窗口是否最小化，如果是最大化
